...
@section('content')
    ...
    <!--== Slider Area Start ==-->
	<section class="hero-wrap hero-wrap-2" style="background-image: url('images/gallery/image_10.jpg');" data-stellar-background-ratio="0.5">
				...
				<div class="row">
					<div class="col-md-3">
						<ul class="ministry-list">
							<li class="active"><a href="#">Healing Touch</a></li>
							<li><a href="#">Healing African</a></li>
							<li><a href="#">Hannah and Esther</a></li>
							<li><a href="#">God chasers & Firebrand-Youth Ministry </a></li>
						</ul>
					</div>
					<div class="col-md-9">
