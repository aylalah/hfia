...
@section('content')
    ...
    <!--== Slider Area Start ==-->
	<section class="hero-wrap hero-wrap-2" style="background-image: url('images/bg_6.jpeg');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
    	...
    	<div class="container">
    		...
    		<div class="row d-flex sermon-wrap">
  				<div class="col-md-6 d-flex align-items-stretch ftco-animate">
  					<div class="img" style="background-image: url(images/bg_7-.jpg);"></div>
  				</div>
  				<div class="col-md-6 py-4 text ftco-animate">
  					<h2 class="mb-4"><a href="sermon.html">About the Church</a></h2>
  					
						<p>The Family of God Charismatic Ministries Worldwide (Inc.) houses Harvest Fire International Assembly, as the church arm, and World Evangelization Movement as world missions outreach arm. Harvest Fire International Assembly is a flourishing church in Nigeria with headquarters in Oyo, Oyo State of Nigeria, having branches in Nigeria.</p>
       ...
       <section class="ftco-section bg-light">
    	<div class="container">
    		...
    		<div class="col-md-6 d-flex align-items-stretch ftco-animate">
  					<div class="img" style="background-image: url(images/img/papa.jpg);"></div>
  				</div>
    		</div>
    	</div>
    </section>
					...
					<div class="col-lg-12">
						<div class="row no-gutters">
							<div class="col-md-3 ftco-animate">
								<a href="images/img/img3.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(images/img/img3.jpg);">
							...
							<div class="col-md-3 ftco-animate">
								<a href="images/img/img4.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(images/img/img4.jpg);">
									<div class="icon mb-4 d-flex align-items-center justify-content-center">
		    						<span class="icon-instagram"></span>
		    					</div>
								</a>
							 ...
							 <div class="col-md-3 ftco-animate">
								<a href="images/img/img5.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(images/img/img5.jpg);">
									<div class="icon mb-4 d-flex align-items-center justify-content-center">
		    						<span class="icon-instagram"></span>
		    					</div>
								</a>
							...
							<div class="col-md-3 ftco-animate">
								<a href="images/img/img6.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(images/img/img6.jpg);">
									<div class="icon mb-4 d-flex align-items-center justify-content-center">
		    						<span class="icon-instagram"></span>
		    					</div>
								</a>
                            ...
                            <div class="col-md-3 ftco-animate">
								<a href="images/img/img7.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(images/img/img7.jpg);">
									<div class="icon mb-4 d-flex align-items-center justify-content-center">
		    						<span class="icon-instagram"></span>
		    					</div>
								</a>
							...
							<div class="col-md-3 ftco-animate">
								<a href="images/img/img8.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(images/img/img8.jpg);">
									<div class="icon mb-4 d-flex align-items-center justify-content-center">
		    						<span class="icon-instagram"></span>
		    					</div>
								</a>
							...
							<div class="col-md-3 ftco-animate">
								<a href="images/img/img12.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(images/img/img12.jpg);">
									<div class="icon mb-4 d-flex align-items-center justify-content-center">
		    						<span class="icon-instagram"></span>
		    					</div>
								</a>
							...
							<div class="col-md-3 ftco-animate">
								<a href="images/img/img14.jpg" class="gallery image-popup img d-flex align-items-center" style="background-image: url(images/img/img14.jpg);">
									<div class="icon mb-4 d-flex align-items-center justify-content-center">
		    						<span class="icon-instagram"></span>
		    					</div>
								</a>
