...
@section('content')
    ...
    <!--== Slider Area Start ==-->
	<section class="hero-wrap hero-wrap-2" style="background-image: url('images/gallery/image_3.jpg');" data-stellar-background-ratio="0.5">
    		...
    		<div class="row d-flex">
    			...
    			<div class="col-md-6 px-5 py-5">
		          ...
		          <div class="col-md-12 heading-section heading-section-no-line ftco-animate">
		            ...
		            <p>Family of God Charismatic Ministries is an interdenominational ministry pastors by his Lordship, Bishop Gift Chuks Nnaji Ministry is headquatered at....with....branches.</p>
		          </div>
		        </div>
		    		<div class="row">
